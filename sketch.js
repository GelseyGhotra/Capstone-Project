...
function preload(){
    ...
    zombie_running = loadAnimation("zombie_running_1.png", "zombie_running_2.png");
    zombie_collided = loadAnimation("zombie_stop.png");
...
function setup() {
  ...
  zombie = createSprite(40,160,20,50);
...
function spawnTrashcan(){
 if (frameCount % 60 === 0){
   var trashcan = createSprite(600,165,10,40);
